...
type Task interface {
	...
	CreateTaskMergeItems(ctx context.Context, boardId, w1, h1, w2, h2 uint) (taskEntity.Task, error)
	CreateTaskClickItem(ctx context.Context, boardId, w1, h1 uint) (taskEntity.Task, error)
}
